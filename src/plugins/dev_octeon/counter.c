...
vnet_dev_counter_t oct_port_counters[] = {
  ...
  VNET_DEV_CTR_VENDOR (OCT_PORT_CTR_RX_DROP_BYTES, RX, BYTES, "drop"),
...
vnet_dev_counter_t oct_rxq_counters[] = {
  ...
  VNET_DEV_CTR_VENDOR (OCT_RXQ_CTR_DROP_BYTES, RX, BYTES, "drop"),
...
vnet_dev_counter_t oct_txq_counters[] = {
  ...
  VNET_DEV_CTR_VENDOR (OCT_TXQ_CTR_DROP_BYTES, TX, BYTES, "drop"),
};
