			    ...
			    vlib_cli_command_t *cmd)
{
  ...
  LINK_SPEED_TEST_ASSERT (vnet_hw_if_speed_from_kbps (10000000) ==
			    VNET_HW_IF_SPEED_10G,
			  "10000000 Kbps -> SPEED_10G");
  LINK_SPEED_TEST_ASSERT (vnet_hw_if_speed_from_kbps (25000000) ==
			    VNET_HW_IF_SPEED_25G,
			  "25000000 Kbps -> SPEED_25G");
  LINK_SPEED_TEST_ASSERT (vnet_hw_if_speed_from_kbps (100000000) ==
			    VNET_HW_IF_SPEED_100G,
			  "100000000 Kbps -> SPEED_100G");
  LINK_SPEED_TEST_ASSERT (vnet_hw_if_speed_from_kbps (99999) ==
			    VNET_HW_IF_SPEED_UNKNOWN,
