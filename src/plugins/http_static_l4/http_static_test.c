...
typedef struct
{
  ...
  u16 msg_id_base;
  vat_main_t *vat_main;
} http_static_l4_test_main_t;

http_static_l4_test_main_t http_static_l4_test_main;

#define __plugin_msg_base http_static_l4_test_main.msg_id_base
#include <vlibapi/vat_helper_macros.h>

static int
api_http_static_l4_enable (vat_main_t *vam)
{
  unformat_input_t *line_input = vam->input;
  vl_api_http_static_l4_enable_t *mp;
  u64 tmp;
  u8 *www_root = 0;
  u8 *uri = 0;
...
#include <http_static_l4/http_static_l4.api_test.c>
