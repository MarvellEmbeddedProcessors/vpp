...
UTILS_LOCATION=${DPDK_DEVBIND_LOCATION:-ci@10.28.36.188:/home/ci/vpp/perf_stage_bins/$PLAT/}
...
function target_sync()
{
	...
	echo "Syncing files to target board..."
	...
	$TARGET_SSH_CMD $TARGET_BOARD "sudo $TARGET_SCP_CMD $UTILS_LOCATION/dpdk-devbind.py ${REMOTE_BUILD_DIR}/ci/test/board/"
	# Sync testpmd
